...
const highlights = [
  {
    ...
    description:
      "Soluções end-to-end para automatizar processos do dia a dia convencional e empresarial.",
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "Projetos que resolvem problemas reais e geram valor para clientes e usuários.",
  },
  {
    icon: GraduationCap,
    title: "Formação IBMEC",
    description:
      "Graduado em Full Stack Development pelo IBMEC Rio de Janeiro.",
  },
];
        ...
        <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {highlights.map((item) => (
            <StaggerItem key={item.title}>
              <div className="group p-6 bg-card border border-border rounded-lg hover:border-primary/50 transition-all duration-300 h-full">
